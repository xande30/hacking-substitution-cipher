...
def main():
    message = 'Sy l nlx sr pyyacao l ylwj eiswi upar lulsxrj isr sxrjsxwjr, ia esmm rwctjsxsza sj wmpramh, lxo txmarr jia aqsoaxwa sr pqaceiamnsxu, ia esmm caytra jp famsaqa sj. Sy, px jia >
    ...
    print(colored('Mapping:','grey'))
    print(letterMapping)
    print()
    print(colored('Original ciphertext:','yellow'))
    print(message)
    print()
    print(colored('Copying hacked message to clipboard:','cyan'))
